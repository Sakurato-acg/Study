    ...
    <script>
        $(function () {
            $("button.addToCart").click(function () {
                ...
                // location.href = "http://localhost:8080/Book_/cartServlet?action=addItem&id=" + attr;
                $.getJSON("http://localhost:8080/Book_/cartServlet", "action=addItemAjax&id=" + attr, function (data) {
                    location.reload();
    ...
    <div id="book">
        ...
        <div style="text-align: center">
            <c:if test="${empty sessionScope.cart.items}">
                ...
                <div>
                    <span style="color: red" class="cartLastName">当前的购物车为空</span>
                </div>
            </c:if>
        ...
        <c:forEach items="${requestScope.page.items}" var="book">
            <div class="b_list">
                ...
                <div class="book_info">
                    ...
                    <div class="book_add">
                        <button bookId="${book.id}" class="addToCart">添加购物车</button>
                    </div>
                </div>
            </div>
